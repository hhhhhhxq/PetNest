...
class LanInteractionDialog(QDialog):
    ...
    def settings(self) -> Settings:
        return replace(self._settings, lan_interaction_enabled=self.lan_enabled_input.isChecked())
    ...
    def _build_ui(self) -> None:
        ...
        left_layout.addWidget(self.manual_ip_button)
        self.lan_enabled_input = QCheckBox("允许附近设备发现我", left)
        ...
        left_layout.addWidget(self.lan_enabled_input)
        self.peer_list = QListWidget(left)
        ...
        left_layout.addWidget(self.peer_list, 1)
...
def _dialog_stylesheet() -> str:
    ...
    QTextEdit, QLineEdit { background: #fcfbf9; border: 1px solid #ebe6df; border-radius: 10px; padding: 8px; }
