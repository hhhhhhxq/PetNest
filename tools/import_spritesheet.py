"""将 Codex 标准 8×9 / 8×11 透明 PNG/WebP 图集导入为 PetNest 宠物包。"""
...
def main(arguments: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(description="导入 Codex 8×9/8×11 透明 PNG/静态 WebP 精灵图到 PetNest")
    parser.add_argument("source", type=Path, help="1536×1872 或 1536×2288 RGBA PNG/静态 WebP 精灵图")
